...
//	volatile long time = 0;
	dimmunix.ConcurrentLinkedQueue.Node<LockGrant> nodeRef = null;
	ConcurrentLinkedQueue<Instance> instances = new ConcurrentLinkedQueue<Instance>();
	...
	public LockGrant(LockGrant lg) {
		this.thread = lg.thread;
		this.lock = lg.lock;
		this.position = lg.position;
	}
