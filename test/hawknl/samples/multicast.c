...
*/
/*
  This sample app shows client and server Multicasting. It is a straight
  port from a standard Multicast demo, so it could be cleaner ;)
...
int main(int argc, char **argv)
{
    ...
    printf("Copywrite 2000-2001 by Phil Frisbie\n");
    ...
    if(isserver == NL_TRUE)
    {
        ...
        /* create a socket */
        /* to just send, you can use port 0 */
        sock = nlOpen(0, NL_MULTICAST);
