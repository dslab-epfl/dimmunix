...
#define NL_MINOR_VERSION 6
#define NL_VERSION_STRING "HawkNL 1.6 beta 3"
...
#define NL_TIMED_OUT            0x011c  /* the function timed out */
#define NL_SOCKET_NOT_FOUND     0x011d  /* the socket was not found in the group */
#define NL_STRING_OVER_RUN      0x011e  /* the string is not null terminated, or is longer than NL_MAX_STRING_LENGTH */
/* for backwards compatability */
